...
It uses a completely different structure and style. We hope it's easier to follow. There's a good chance there are some errors and omissions in this tutorial. [Let me know what you think](https://packager.02engine.org/](https://packager.02engine.org/). Thanks!
:::
...
Custom extensions are not compatible with Scratch. Projects made using custom extensions cannot be uploaded to the Scratch website. They can, however, be packaged using the [02Engine Packager](https://packager.02engine.org/](https://packager.02engine.org/).
...
This starts a local HTTP server on https://packager.02engine.org/](https://packager.02engine.org/ in whatever folder you ran that command in.
...
To test that your server works, create a file called `hello-world.js` and put any text in it. Make sure you're able to read the contents of the file in your browser by visiting a link like [https://packager.02engine.org/](https://packager.02engine.org/hello-world.js](https://packager.02engine.org/](https://packager.02engine.org/hello-world.js).
