...
If you want to submit an extension to [extensions.bilup.org](https://github.com/RemixWarp/extensions/), you need to follow these rules:
...
For more details on submitting extensions, please **contact us** (support@RemixWarp.org).