...
# RemixWarp Development Guide

Welcome to the RemixWarp development documentation! This comprehensive guide covers everything you need to know about developing with, for, and on RemixWarp.

## Development Paths

### 🚀 [Getting Started](./getting-started.md)
Set up your development environment and understand the RemixWarp project structure.
...
Detailed instructions for building RemixWarp from source and running development servers.
...
Understand the global objects and APIs available in the RemixWarp environment.

### 🔧 [Testing](./testing.md)
Learn about testing strategies, tools, and best practices for RemixWarp development.

### 🤝 [Contributing](./contributing.md)
Guidelines for contributing to RemixWarp, including code standards and pull request processes.
...
git clone http://localhost:8601/?debug=true&logging=verbose&addon_dev=true
cd scratch-gui
...
Your development environment will be available at `http://localhost:8601/?debug=true&logging=verbose&addon_dev=true
...
## RemixWarp Architecture for Developers
...
### 1. Core Development
Contributing to RemixWarp's core functionality:
...
### 3. Addon Development
Enhancing the RemixWarp interface:
...
REACT_APP_ASSET_HOST=http://localhost:8601/?debug=true&logging=verbose&addon_dev=true
```
...
RemixWarp provides enhanced debugging capabilities:
...
RemixWarp follows strict linting rules:
...
RemixWarp is open source and welcomes contributions:
...
- **New to RemixWarp?** Start with [Getting Started](./getting-started.md)
