...
- **Get it into the RemixWarp extension gallery.** The gallery lives at [extensions.bilup.org](https://extensions.bilup.org); extensions served from that origin run unsandboxed automatically. Follow the submission instructions on the gallery site itself.
