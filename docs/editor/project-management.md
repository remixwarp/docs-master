...
This page covers the lifecycle of a project: starting a new one, saving it (to your computer or to your RemixWarp account), loading it back, sharing it, and remixing. Most of these actions live in the [File menu](/editor/menu-bar).
...
There are two independent places a project can be saved: to your computer as a file, or to your RemixWarp account online. They do not conflict; a project can be both.
