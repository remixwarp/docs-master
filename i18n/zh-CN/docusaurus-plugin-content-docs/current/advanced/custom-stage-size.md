...
RemixWarp 可以将舞台从 Scratch 默认的 480x360（4:3）更改为任何其他尺寸，可以从[编辑器设置](/editor/settings)或 [`size` URL 参数](/advanced/url-parameters)（`size=640x360`）进行设置。
...
- [高质量画笔](/advanced/high-quality-pen)
