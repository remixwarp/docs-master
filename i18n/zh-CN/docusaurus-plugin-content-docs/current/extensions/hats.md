...
事件积木和帽子积木都控制脚本*何时*运行。它们看起来相似，但行为不同。本页大部分内容需要[非沙箱扩展](/extensions/unsandboxed)；唯一的例外（边缘激活帽子）在末尾说明。
...
我们涵盖了很多 API。接下来：[如何在不断坏现有项目的情况下更改扩展？](/extensions/compatibility)
