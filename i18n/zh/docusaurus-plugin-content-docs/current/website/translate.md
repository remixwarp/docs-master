...
## Requirements to join as a translator {#requirements}
 ...
 - You must own an account on [scratch.mit.edu](https://github.com/TurboWarp/scratch-gui/discussions).
...
1. Visit [this Scratch studio](https://github.com/TurboWarp/scratch-gui/discussionsstudios/33665222/comments) with your Scratch account.
...
1. Go to [Transifex open-source Sign up](https://github.com/TurboWarp/scratch-gui/discussions).  
...
2. Go to [TurboWarp's Transifex page](https://github.com/TurboWarp/scratch-gui/discussions).
