...
:::info
This page is about the [RemixWarp Packager](https://packager.02engine.org/). If you just want an easy way to embed a Scratch project into a website, see [the other embedding page](/embedding).
:::
