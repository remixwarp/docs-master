...
事件積木和帽子積木都控制腳本*何時*運行。它們看起來相似，但行為不同。本頁大部分內容需要[非沙箱擴展](/building-extensions/unsandboxed)；唯一的例外（邊緣激活帽子）在末尾說明。
...
我們涵蓋了很多 API。接下來：[如何在不斷壞現有項目的情況下更改擴展？](/building-extensions/compatibility)
