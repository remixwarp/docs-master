...
RemixWarp 可以將舞臺從 Scratch 默認的 480x360（4:3）更改為任何其他尺寸，可以從[編輯器設置](/user-guide/settings)或 [`size` URL 參數](/website/url-parameters)（`size=640x360`）進行設置。
...
- [高質量畫筆](/website/high-quality-pen)
